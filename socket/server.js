...
async function getCachedUserData(userId) {
  ...
  try {
    ...
    const data = {
      ...
      avatarType: userDb?.profile?.avatarType || 'EMOJI',
      ...
      socketsA.forEach((sId) => {
        io.to(sId).emit('random_match_found', {
          ...
          partner: {
            ...
            avatarType: candidateB.avatarType || 'EMOJI',
      ...
      socketsB.forEach((sId) => {
        io.to(sId).emit('random_match_found', {
          ...
          partner: {
            ...
            avatarType: candidateA.avatarType || 'EMOJI',
    ...
    if (match) {
      ...
      socket.emit('random_match_found', {
        ...
        partner: {
          ...
          avatarType: partner.avatarType || 'EMOJI',

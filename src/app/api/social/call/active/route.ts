      ...
      include: {
        caller: {
          select: {
            ...
            membershipTier: true,
            is_vip: true,
            profile: { select: { avatarUrl: true, avatarType: true, avatarEmoji: true } },
          },
        },
        receiver: {
          select: {
    ...
    return NextResponse.json({
      activeCall: {
        ...
        otherUser: {
          ...
          avatarType: otherUser.profile?.avatarType || 'EMOJI',
          avatarEmoji: otherUser.profile?.avatarEmoji || '😊',
          isVIP: otherUser.membershipTier === 'VIP' || Boolean(otherUser.is_vip),
        },
      },
    });
  } catch (error: any) {
